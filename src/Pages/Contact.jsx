...
function Contact() {
    const { hasCopied, onCopy } = useClipboard('harshsharmaktm03@gmail.com')
    const handleGithub = () => {
        window.location.href = "https://github.com/Harsh2004R";
    }
    const handleLinkdin = () => {
        window.location.href = "https://www.linkedin.com/in/harsh-sharma-0545aa25b/";
    }
    const handleResume = () => {
        window.location.href = "https://drive.google.com/file/d/1fj19qekBJPV7Gk-ZDzEvm40BZiOuQmzX/view?usp=sharing";
    }
                            ...
                            <Stack
                                ...
                                <Stack
                                    ...
                                    <Tooltip
                                        ...
                                        label={hasCopied ? 'Email Copied!' : 'Go to top'}
                                        closeOnClick={false}
                                        hasArrow>
                                        <IconButton
                                    ...
                                    <Box as="a" href="#">
                                        <IconButton
                                            ...
                                            variant="ghost"
                                            size="lg"
                                            icon={<BsTwitter color='#fff' size="28px" />}
                                            _hover={{
                                                bg: 'blue.500',
                                                color: useColorModeValue('white', 'gray.700'),
                                            }}
                                    ...
                                    <Box as="a" href="#">
                                        <IconButton
                                            ...
                                            variant="ghost"
                                            size="lg"
                                            icon={<BsLinkedin color='#fff' size="28px" />}
                                            _hover={{
                                                bg: 'blue.500',
                                                color: useColorModeValue('white', 'gray.700'),
                                            }}
                                ...
                                <Box
                                    ...
                                    alignContent={"center"}
                                    alignItems={"center"}
                                    backgroundImage="url('https://i.ibb.co/R0kvCK4/Wood-bg.jpg')"
